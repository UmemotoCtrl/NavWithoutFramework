...
window.navbarWoFw = {
	...
	onClickHamb: function (event) {
		...
		self.NavWoFwMenu.style.height = '10rem';
		self.NavWoFwMenu.style.overflow = 'visible';
	},
	onClickCross: function (event) {
		var self = window.navbarWoFw.elements;
		self.NavWoFwHamb.style.display = 'block';
		self.NavWoFwCross.style.display = 'none';
		self.NavWoFwMenu.style.height = '0';
		self.NavWoFwMenu.style.overflow = 'hidden';
	},
	render: function () {
